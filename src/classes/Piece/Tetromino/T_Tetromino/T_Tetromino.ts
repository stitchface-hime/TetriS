...
export class T_Tetromino extends Tetromino {
    ...
    protected static override color = "#952d98";
    ...
    constructor(originCoordinates: [x: number, y: number], matrix: Matrix) {
        ...
        const blocks: [Block, Block, Block, Block] = [
            new Block([originX, originY], matrix, T_Tetromino.color), // 0
            new Block([originX - 1, originY], matrix, T_Tetromino.color), // 1
            new Block([originX, originY + 1], matrix, T_Tetromino.color), // 2
            new Block([originX + 1, originY], matrix, T_Tetromino.color), // 3
        ];

...
export class S_Tetromino extends Tetromino {
    ...
    protected static override color = "#60b21c";
    ...
    constructor(originCoordinates: [x: number, y: number], matrix: Matrix) {
        ...
        const blocks: [Block, Block, Block, Block] = [
            new Block([originX, originY], matrix, S_Tetromino.color), // 0
            new Block([originX - 1, originY], matrix, S_Tetromino.color), // 1
            new Block([originX, originY + 1], matrix, S_Tetromino.color), // 2
            new Block([originX + 1, originY + 1], matrix, S_Tetromino.color), // 3
        ];
